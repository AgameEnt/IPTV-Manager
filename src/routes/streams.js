...
router.get('/live/token/auth/:stream_id.ts', redirectLive);
router.get(['/live/token/auth/:stream_id.m3u8', '/live/token/auth/:stream_id.mp4', '/live/token/auth/:stream_id.mp3', '/live/token/auth/:stream_id.aac'], streamController.proxyLive);
